# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 10:06:35 2020
...
class Inventory:
    ...
    def compute_inventory(self):
        ...
        return 'The total inventory is : ' + '<p>' + '$'+ str(total) + '</p>'
...
class Item:
    ...
    def __str__(self):
        ...
        s = '******************<br>'+ 'ID: '+ str(self.count) + '<br>' + 'Name: ' + \
            self.name + '<br>' + 'Price: ' + self.price + '<br>' + 'Date: ' + \
                self.date + '<br>' + 'Quantity: '+ self.quantity
        return s
...
class Book(Item):
    ...
    def __str__(self):
        s = super().__str__() + '<br>' + 'Publisher: ' + self.publisher + '<br>'\
            + 'Author: ' + self.author + '<br>' + 'ISBN: ' + self.isbn
        return s
...
class Cd_vinyl(Item):
    ...
    def __str__(self):
        s = super().__str__() + '<br>' + 'Artist: ' + self.artist + '<br>' +\
            'Label: ' + self.label + '<br>' + 'ASIN: ' + self.asin
        return s
...
class Collectible(Item):
    ...
    def __str__(self):
        s = super().__str__() + '<br>' + 'Owner: ' + self.owner
        return s
...
class Ebay(Item):
    ...
    def __str__(self):
        s = super().__str__() + '<br>' + 'Manufacturer: ' + self.manufacturer
        return s
